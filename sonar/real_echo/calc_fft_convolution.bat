...
set REC_FILE=Rx_7_UT38393us.wav
...
python plot_csv_file.py convolutionFFT.csv 11 15 DistM RealLog2
python plot_csv_file.py convolutionFFT.csv 11 7 DistM Abs
python plot_csv_file.py convolutionFFT.csv 11 13 DistM AbsLog2
